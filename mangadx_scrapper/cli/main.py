"""
Main command-line interface for MangaDx Scrapper.

This module provides the main CLI entry point with interactive menu.
"""
...
class CLI:
    ...
    def print_header(self) -> None:
        ...
        print(f"\n{Fore.CYAN}{'=' * 60}")
        print(f"{Fore.CYAN}  MangaDx Manga Scrapper v1.0")
    ...
    def search_manga(self) -> Optional[str]:
        ...
        Returns:
            Selected manga ID or None if cancelled or error occurred
        """
        try:
            print(f"\n{Fore.YELLOW}{'─' * 60}")
    ...
    def get_download_options(self) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with download options including languages, filters, and settings
        """
    ...
    def download_manga(self, manga_id: str) -> None:
        """
...
def main():
    """Main entry point for mangadx-scrapper command."""
    parser = argparse.ArgumentParser(
        description="MangaDx Manga Scrapper - Download manga from MangaDx",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  mangadx-scrapper                    # Interactive mode
  mangadx-scrapper --help             # Show this help
        """
    )
